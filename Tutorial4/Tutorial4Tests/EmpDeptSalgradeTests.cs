...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnAllSalesmen()
    {
        ...
        List<Emp> result = emps.WHERE(e=>e.Job == "SALESMEN").ToList(); 
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result = emps.Where(e => chicagoDeptNos.Contains(e.DeptNo)).ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            .Join(grades,
                e => e.Sal,
                s => s,
                (e, s) => new { e.EName, Grade = grades.First(g => e.Sal >= g.Losal && e.Sal <= g.Hisal).Grade })
            .ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps.Where(e => e.Sal > emps.Where(inner => inner.DeptNo == e.DeptNo).Average(inner => inner.Sal)).Select(e => e.EName).ToList();
